...
-- UNIVERSITY RESOURCE
INSERT INTO UNIVERSITYRESOURCE (RESOURCE_ID, RESOURCE_NAME, RESOURCE_FORMAT, OWNER_STAFF_ID, OWNER_STUDENT_ID, SCHOOL_ID)
VALUES (1, 'CS5001 EXAM PAPER', 'PDF', 'LECTURER1', NULL, 1);

INSERT INTO UNIVERSITYRESOURCE (RESOURCE_ID, RESOURCE_NAME, RESOURCE_FORMAT, OWNER_STAFF_ID, OWNER_STUDENT_ID, SCHOOL_ID)
VALUES (2, 'CS5001 STUDENT SUBMISSION', 'DOC', NULL, 'STUDENT1', 1);

INSERT INTO UNIVERSITYRESOURCE (RESOURCE_ID, RESOURCE_NAME, RESOURCE_FORMAT, OWNER_STAFF_ID, OWNER_STUDENT_ID, SCHOOL_ID)
VALUES (3, 'RESEARCH PAPER', 'DOC', NULL, 'STUDENT1', 1);

INSERT INTO UNIVERSITYRESOURCE (RESOURCE_ID, RESOURCE_NAME, RESOURCE_FORMAT, OWNER_STAFF_ID, OWNER_STUDENT_ID, SCHOOL_ID)
VALUES (4, 'CS5001 LECTURE NOTE 1', 'PPTX', 'LECTURER1', NULL, 1);

INSERT INTO UNIVERSITYRESOURCE (RESOURCE_ID, RESOURCE_NAME, RESOURCE_FORMAT, OWNER_STAFF_ID, OWNER_STUDENT_ID, SCHOOL_ID)
VALUES (5, 'CS EVENT BROCHURE', 'PDF', NULL, NULL, 1);

INSERT INTO UNIVERSITYRESOURCE (RESOURCE_ID, RESOURCE_NAME, RESOURCE_FORMAT, OWNER_STAFF_ID, OWNER_STUDENT_ID, SCHOOL_ID)
VALUES (6, 'PUBLIC NEWS', 'PDF', NULL, NULL, 1);
